      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form wire:submit.prevent='storeVillage' action="">
            ...
            <div class="row mb-3">
              <label for="status_desa_id" class="col-md-4 col-lg-3 col-form-label py-0">
                Status Desa
                @include('components.ui.form.required')
              </label>
              <div class="col-md-8 col-lg-9">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-8 col-lg-9">
                <textarea wire:model='potensi' name="potensi" class="form-control @error('potensi') is-invalid @enderror"
